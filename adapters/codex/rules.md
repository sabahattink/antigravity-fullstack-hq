...
- Codex loads global guidance from `~/.codex/AGENTS.md` and repository guidance
  from the nearest applicable `AGENTS.md` files.
- If `~/.codex/AGENTS.override.md` exists, Codex uses it instead of the global
  `AGENTS.md`; the installer leaves that override untouched.
